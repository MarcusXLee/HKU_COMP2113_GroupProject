...
Enemy createEnemy(EnemyType type, bool isHard) 
{
    switch (type) {
        ...
        case EnemyType::WanderingMerchant_Forest:   return makeEnemy("Merchant (Forest)", 10, 2, 4, isHard);
        ...
        case EnemyType::BrownBear:                  return makeEnemy("Brown Bear", 8, 3, 2, isHard);
        ...
        case EnemyType::DemonKingBoss:              return makeEnemy("Demon King (BOSS)", 40, 9, 6, isHard);
    }
